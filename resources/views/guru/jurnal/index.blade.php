    ...
    <form method="GET" action="{{ route('guru.jurnal.index') }}">
        <div class="grid grid-cols-1 lg:grid-cols-[1fr_210px_auto] gap-3">
            ...
            <div class="relative min-w-0">
                <svg
                    class="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="2"
                    viewBox="0 0 24 24"
            ...
            <div class="min-w-0">
                ...
                >
                    ...
                    <option value="Menunggu Review" {{ ($status ?? '') === 'Menunggu Review' ? 'selected' : '' }}>
                        Menunggu Review
                    </option>
                    ...
                    <option value="Perlu Revisi" {{ ($status ?? '') === 'Perlu Revisi' ? 'selected' : '' }}>
                        Perlu Revisi
                    </option>
                </select>
            </div>
                ...
                <table class="w-full text-sm text-left border-collapse">
                    ...
                    <thead>
                        <tr class="border-b border-slate-800 bg-slate-900/80 text-slate-400">
                            ...
                            <th class="px-6 py-3.5 text-[11px] uppercase tracking-wider font-semibold text-right" translate="no">
                                Aksi
                            </th>
            ...
            <div class="px-6 py-16 text-center">
                ...
                @if(($search ?? false) || ($status ?? false))
                    ...
                    <p class="mt-1 text-xs text-slate-400 max-w-xs mx-auto">
                        ...
                        @elseif($status ?? false)
                            Tidak ada jurnal dengan status "{{ $status }}".
                        @endif
