<x-app-layout>
    ...
    <x-slot:header>
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-[14px] lg:text-[15px] font-bold text-white">Edit Siswa</h2>
                <p class="text-[11px] hidden sm:block" style="color: var(--text-muted);">Ubah data {{ $siswa->nama }}</p>
            </div>
        </div>
    </x-slot:header>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-2.5 p-3 rounded-lg" style="background: rgba(139,92,246,0.06); border: 1px solid rgba(139,92,246,0.1);">
                    ...
                    <p class="text-[10.5px] leading-relaxed" style="color: var(--text-muted);">
                        Biarkan kolom kata sandi kosong jika tidak ingin mengubahnya. Jika diisi, minimal 8 karakter dan wajib dikonfirmasi.
                    </p>
                </div>
            </div>
        </div>
