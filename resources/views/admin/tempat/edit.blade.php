<x-app-layout>
    ...
    <x-slot:header>
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-[14px] lg:text-[15px] font-bold text-white">Edit Tempat PKL</h2>
                <p class="text-[11px] hidden sm:block" style="color: var(--text-muted);">Ubah data {{ $tempat->nama_perusahaan }}</p>
            </div>
        </div>
    </x-slot:header>
    ...
    <form action="{{ route('admin.tempat.update', $tempat) }}" method="POST" class="max-w-2xl mx-auto">

        @csrf
        @method('PUT')

        {{-- ===== SECTION: DATA PERUSAHAAN ===== --}}
        <div class="card p-5 mb-5 anim anim-d1" style="border-color: rgba(16,185,129,0.12);">
            <div class="flex items-center gap-3 mb-5 pb-4" style="border-bottom: 1px solid rgba(16,185,129,0.1);">
                ...
                <span class="ml-auto text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded" style="background: rgba(16,185,129,0.08); color: var(--accent-green);">Edit</span>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="bidang"
                               ...
                               placeholder="Contoh: IT, Akuntansi" required>
                    </div>
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="2"
                              ...
                              placeholder="Jl. Contoh No. 123, Kota">{{ old('alamat', $tempat->alamat) }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="2"
                              class="input-dark w-full rounded-lg px-3.5 py-2.5 text-[12.5px] resize-none"
                              placeholder="Catatan tambahan (opsional)">{{ old('keterangan', $tempat->keterangan) }}</textarea>
                </div>
            </div>
        </div>
