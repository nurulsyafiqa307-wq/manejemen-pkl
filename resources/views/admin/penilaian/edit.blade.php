<x-app-layout>
    ...
    <x-slot name="header">
        <div>
            <h1 class="text-3xl font-bold text-white">Edit Penilaian PKL</h1>
            <p class="text-slate-400 mt-1">Perbarui nilai siswa PKL</p>
        </div>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-2xl p-8">
            ...
            <form action="{{ route('admin.penilaian.update', $penilaian->id) }}"
                  method="POST"
                  class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text"
                           id="rata_rata"
                           value="{{ number_format($penilaian->rata_rata, 2) }}"
                           readonly
                ...
                <div>
                    ...
                    <textarea name="catatan"
                              rows="4"
                              class="w-full rounded-xl bg-slate-900 border border-slate-700 text-white px-4 py-3">{{ old('catatan', $penilaian->catatan) }}</textarea>
                </div>
