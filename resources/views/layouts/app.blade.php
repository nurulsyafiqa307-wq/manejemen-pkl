    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        body::before {
            ...
            inset: 0;
            background:
                radial-gradient(ellipse 80% 60% at 20% 10%, rgba(79,142,255,0.06) 0%, transparent 60%),
        ...
        .stat-card.blue::after  { background: radial-gradient(circle, rgba(79,142,255,0.06) 0%, transparent 70%); }
        .stat-card.purple::after { background: radial-gradient(circle, rgba(139,92,246,0.06) 0%, transparent 70%); }
        .stat-card.amber::after  { background: radial-gradient(circle, rgba(245,158,11,0.06) 0%, transparent 70%); }
        .stat-card.green::after  { background: radial-gradient(circle, rgba(34,197,94,0.06) 0%, transparent 70%); }
        ...
        .welcome-banner {
            ...
            overflow: hidden;
            border-radius: 16px;
            background: linear-gradient(135deg, #1a3a6e 0%, #2d1b69 50%, #4a1942 100%);
        }
        ...
        .table-dark tbody tr { transition: background 0.15s ease; }
        .table-dark tbody tr:hover td { background: rgba(255,255,255,0.015); }
        ...
        .badge-info    { background: rgba(79,142,255,0.12); color: #60a5fa; }
...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen flex relative" style="z-index: 1;">
        ...
        <aside id="sidebarPanel" class="sidebar-panel sidebar-bg fixed inset-y-0 left-0 z-50 flex flex-col">
            ...
            <div class="flex h-[60px] items-center gap-2.5 px-4 shrink-0" style="border-bottom: 1px solid var(--border);">
                <div class="float-anim flex h-8 w-8 items-center justify-center rounded-lg"
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-[9px] font-medium" style="color: var(--accent-blue);">Sistem Informasi</p>
                </div>
            </div>

            <nav class="sidebar-scroll flex-1 px-2.5 py-4 overflow-y-auto">
                <p class="mb-2 px-2.5 text-[9px] font-bold uppercase tracking-[0.1em]" style="color: var(--text-dim);">Menu</p>
                <div class="space-y-0.5">
                   ...
                   <a href="{{ route('admin.guru.index') }}"
                    ...
                    <a href="{{ route('admin.tempat.index') }}"
                        ...
                        <i data-lucide="building-2" class="h-4 w-4 shrink-0"></i> Tempat PKL
                    </a>
                    <a href="{{ route('admin.pengajuan.index') }}"
                        ...
                        @endphp
                        @if($pendingCount > 0)
                            <span class="flex h-[18px] min-w-[18px] items-center justify-center rounded-md px-1 text-[9px] font-bold"
                                  style="background: rgba(245,158,11,0.12); color: #fbbf24;">{{ $pendingCount }}</span>
                        @endif
                    </a>
                </div>
            ...
            <div class="shrink-0 px-3 py-3" style="border-top: 1px solid var(--border); background: rgba(8,14,31,0.9);">
                <div class="flex items-center gap-2.5">
                    <div class="avatar h-8 w-8 text-[11px]"
                         style="background: linear-gradient(135deg, var(--accent-blue), var(--accent-purple));">
        ...
        <div class="main-content min-h-screen flex flex-col flex-1">
            ...
            <header class="topbar-bg sticky top-0 z-30 flex h-[60px] items-center justify-between px-4 lg:px-6">
                <div class="flex items-center gap-3">
                    <button onclick="toggleSidebar()"
                            class="flex h-8 w-8 items-center justify-center rounded-md lg:hidden transition hover:bg-white/5"
                ...
                <div class="flex items-center gap-2">
                    <div class="hidden items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-[11px] font-medium sm:flex input-dark">
                        ...
                        <span class="hidden md:inline">{{ \Carbon\Carbon::now()->locale('id')->translatedFormat('l, d F Y') }}</span>
                        <span class="md:hidden">{{ \Carbon\Carbon::now()->format('d M Y') }}</span>
                    </div>
                    {{-- <button class="relative flex h-8 w-8 items-center justify-center rounded-lg input-dark transition hover:bg-white/5"
                            style="color: var(--text-secondary);">
                    ...
                    <div class="hidden h-8 w-8 items-center justify-center rounded-lg text-[11px] font-bold text-white sm:flex"
                         style="background: linear-gradient(135deg, var(--accent-blue), var(--accent-purple));">
                        {{ strtoupper(substr(Auth::user()->name ?? 'A', 0, 1)) }}
                    </div>
                </div>
            ...
            <footer class="px-6 py-3 text-center text-[10px]" style="border-top: 1px solid var(--border); color: var(--text-dim);">
