...
>
    ...
    <div
        ...
        class="fixed inset-0 bg-black/60 backdrop-blur-[2px] z-40 lg:hidden"
        x-cloak
    ></div>
    ...
    >
        ...
        <div class="h-16 px-4 sm:px-5
            ...
            <div class="ml-3 min-w-0">
                <h1 class="text-[13px] font-bold tracking-wide text-white truncate">
                    MANEJEMEN PKL
                </h1>
        ...
        >
            ...
            <div class="flex items-center gap-2.5 shrink-0">
                ...
                <div class="text-right hidden sm:block">
                    <p class="text-[13px] font-medium text-white leading-tight truncate max-w-[180px]">
                        {{ auth()->user()->name ?? 'Guru' }}
                    </p>
