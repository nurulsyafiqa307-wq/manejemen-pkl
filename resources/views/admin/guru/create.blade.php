<x-app-layout>
    ...
    <x-slot:header>
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-[14px] lg:text-[15px] font-bold text-white">Tambah Guru</h2>
                <p class="text-[11px] hidden sm:block" style="color: var(--text-muted);">Buat data guru & akun login baru</p>
            </div>
        </div>
    </x-slot:header>
    ...
    <form action="{{ route('admin.guru.store') }}" method="POST" class="max-w-2xl mx-auto">

        @csrf

        {{-- ===== SECTION 1: DATA GURU ===== --}}
        <div class="card p-5 mb-4 anim anim-d1" style="border-color: rgba(139,92,246,0.12);">
            <div class="flex items-center gap-3 mb-5 pb-4" style="border-bottom: 1px solid rgba(139,92,246,0.1);">
                <div class="flex h-9 w-9 items-center justify-center rounded-lg" style="background: rgba(139,92,246,0.1);">
                    <i data-lucide="user-plus" class="h-[18px] w-[18px]" style="color: var(--accent-purple);"></i>
                </div>
                <div>
                ...
                <span class="ml-auto text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded" style="background: rgba(139,92,246,0.08); color: var(--accent-purple);">Langkah 1</span>
            </div>
        ...
        <div class="card p-5 mb-5 anim anim-d2" style="border-color: rgba(79,142,255,0.12);">
            <div class="flex items-center gap-3 mb-5 pb-4" style="border-bottom: 1px solid rgba(79,142,255,0.1);">
                <div class="flex h-9 w-9 items-center justify-center rounded-lg" style="background: rgba(79,142,255,0.1);">
                    <i data-lucide="shield-check" class="h-[18px] w-[18px]" style="color: var(--accent-blue);"></i>
                </div>
                <div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-2.5 p-3 rounded-lg" style="background: rgba(79,142,255,0.06); border: 1px solid rgba(79,142,255,0.1);">
                    <i data-lucide="info" class="h-3.5 w-3.5 shrink-0 mt-0.5" style="color: var(--accent-blue);"></i>
                    <p class="text-[10.5px] leading-relaxed" style="color: var(--text-muted);">
                        Akun login dibuat otomatis setelah data disimpan. Guru bisa masuk ke sistem menggunakan email dan kata sandi di atas.
                    </p>
                </div>
            </div>
        </div>
